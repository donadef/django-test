...
function update_job_name_with_project_name() {
    ...
    var i = document.getElementById("id_job_name").value.split(" - ")[1];
//    console.log(i);
    if (typeof i === 'undefined'){ i = '' };
    document.getElementById("id_job_name").value = x + " - " + i;
    document.getElementById("id_job_name_errors").style.display = 'none';
};

function update_job_name_with_protocol_name() {
    var x = document.getElementById("id_protocol_name").value;
    var i = document.getElementById("id_job_name").value.split(" - ")[0];
    document.getElementById("id_job_name").value = i + " - " + x;
    document.getElementById("id_job_name_errors").style.display = 'none';
};
